...
export function BloodUnitLabel({
  ...
  return (
    <div
      ...
      className={`printable-unit-label w-full max-w-[500px] border-2 border-black bg-white p-3.5 text-black font-mono select-none text-left [dir='ltr'] ${className}`}
      dir="ltr"
    >
      {/* Official ISBT 128 Header Bar */}
      <div className="flex items-center justify-between border-b-2 border-black pb-2 mb-2.5">
        <div>
          <span className="block text-[10px] font-black tracking-wider uppercase text-gray-800">
        ...
        <div className="text-right">
          <span className="inline-block border border-black bg-black px-1.5 py-0.5 text-[9px] font-bold text-white uppercase tracking-wider">
            CLINICAL SPECIMEN
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 border-2 border-black divide-x-2 divide-black text-xs">
        ...
        <div className="p-2.5 flex flex-col justify-between border-b-2 border-black min-h-[140px]">
          <div>
            <span className="block text-[9px] font-bold uppercase tracking-wider text-gray-700">
              {t("bloodBank.productIdentifier", "Donation ID (DIN)")}
            </span>
            <span className="block text-base font-black tracking-wide leading-tight">
              {unit.id}
            </span>
          </div>

          {/* Primary Linear Barcode (Code 128) */}
          <div className="my-1.5 flex justify-center py-0.5 bg-white">
            <MedicalBarcode
              value={unit.id}
              width={1.4}
              height={38}
          ...
          <div className="text-[10px] space-y-0.5 pt-1 border-t border-dashed border-gray-400">
        ...
        <div className="p-2.5 flex flex-col justify-between border-b-2 border-black min-h-[140px] bg-gray-50/70">
          <div className="flex items-start justify-between">
            ...
            <div className="border-2 border-black bg-white px-3 py-1 text-center shadow-xs">
          ...
          <div className="text-[10px] text-gray-700 pt-1 border-t border-dashed border-gray-400 flex justify-between">
        ...
        <div className="p-2.5 flex flex-col justify-between min-h-[145px]">
          <div>
            <span className="block text-[9px] font-bold uppercase tracking-wider text-gray-700">
              {t("common.component", "Biological Component")}
            </span>
            <span className="block text-xs font-black uppercase text-black leading-tight mt-0.5">
          ...
          <div className="text-[10px] space-y-1 pt-1.5 border-t border-dashed border-gray-400">
            <div>
              <span className="block text-[9px] text-gray-600 uppercase font-semibold">
                REQUIRED COLD CHAIN:
              </span>
        ...
        <div className="p-2.5 flex flex-col justify-between min-h-[145px] bg-gray-50/70">
          <div>
            <span className="block text-[9px] font-bold uppercase tracking-wider text-gray-700">
              {t("bloodBank.expiry", "Expiration Date")}
            </span>
            <span className="block text-sm font-black underline decoration-2 tracking-wide text-black">
              {expiryDateFormatted}
            </span>
            ...
            <div className="mt-1">
              ...
              <span className="block font-bold text-[10px] text-black truncate">
          ...
          {showQr ? (
            <div className="flex items-center gap-2 pt-1.5 border-t border-dashed border-gray-400">
              ...
              <div className="text-[8px] leading-tight text-gray-700 uppercase">
                <span className="font-bold block text-[9px]">SCAN FOR AUDIT</span>
      ...
      <div className="mt-2 pt-1.5 border-t border-black text-[9px] text-gray-700 flex justify-between items-center">
