...
export function BloodBanksPage() {
  ...
  const [selectedBloodBankToEdit, setSelectedBloodBankToEdit] =
    useState<AdminBloodBank | null>(null);
  const [selectedBloodBankToView, setSelectedBloodBankToView] =
    useState<AdminBloodBank | null>(null);
    ...
    <AdminPageFrame
      ...
      actions={
        <Button onClick={handleOpenCreate} size="sm" className="gap-1.5">
          ...
          <span>
            {t("admin.registerBloodBankAction", "Register Blood Bank")}
          </span>
        </Button>
      }
    >
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div className="relative sm:col-span-2">
              ...
              <Input
                ...
                placeholder={t(
                  "admin.searchBloodBanksPlaceholder",
                  "Search blood banks by name, code, address...",
                )}
                className="ps-9"
              />
            </div>
        ...
        {isLoading || !bloodBanks ? (
          <LoadingState
            label={t("common.loadingRecords", "Loading blood bank facilities…")}
            rows={6}
          />
        ) : (
          <BloodBanksTable
